    ...
    <>
      ...
      >
        ...
        <button
          ...
          className={cn(
            "absolute top-[31px] right-[31px] w-[18px] h-[18px] flex items-center justify-center text-[18px] text-gray-500 hover:text-gray-700",
        ...
        >
          ...
          <img
            ...
            alt="对话"
            className="w-[20px] h-[25px] mr-[10px]"
          />
          {/* 当前对话标题 */}
          <div
            className="text-[14px] text-[#666666] font-[500]"
          >
        ...
        {/* 知识库列表标题 */}
        <div
          className="flex items-center mt-[20px] ml-[32px]"
        >
          {/* 知识库图标 */}
          <img
        ...
        {/* 知识库列表 */}
        <div
          className="absolute top-[200px] left-0 right-0 bottom-[100px] px-[32px] overflow-y-auto overflow-x-hidden"
        >
          {isLoading ? (
            <div
        ...
        >
          <button
            ...
            disabled={isAdding}
            className={cn(
              "w-[128px] h-[40px] bg-[#FFFFFF] rounded-[20px] border border-[#C8C9CC]",
              "text-[16px] text-[#666666] transition-all duration-200 ease",
          ...
          <button
            ...
            disabled={isAdding}
            className={cn(
              "w-[128px] h-[40px] rounded-[20px] border-0 text-[16px] text-[#FFFFFF]",
